        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 border border-orange-100">
            ...
            <form method="POST" action="{{ route('register') }}" autocomplete="off">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required autocomplete="off" class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition" style="border-color: #E8C5A5; color: #5A3A1A;" onfocus="this.style.borderColor='#D2691E'" onblur="this.style.borderColor='#E8C5A5'" placeholder="Masukkan username">
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-2" style="color: #5A3A1A;">
                        <i class="fas fa-id-card mr-2" style="color: #D2691E;"></i>Nama Lengkap
                    </label>
                    <input type="text" name="nama" value="{{ old('nama') }}" required autocomplete="off" class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition" style="border-color: #E8C5A5; color: #5A3A1A;" onfocus="this.style.borderColor='#D2691E'" onblur="this.style.borderColor='#E8C5A5'" placeholder="Masukkan nama lengkap">
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-2" style="color: #5A3A1A;">
