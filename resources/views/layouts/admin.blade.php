    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header class="gradient-bg px-8 py-6 sticky top-0 z-10 shadow-2xl">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">@yield('title')</h1>
            <p class="text-base text-orange-100 mt-2 font-medium">@yield('subtitle', 'Sistem Peminjaman Ruangan')</p>
          </div>
          <div class="flex items-center gap-4">
            <div class="text-right bg-white bg-opacity-20 backdrop-blur-sm px-6 py-3 rounded-2xl">
              <p class="text-lg font-bold text-white">{{ Auth::user()->nama ?? Auth::user()->username }}</p>
