...
@section('page-subtitle', 'Daftar petugas yang mengelola sistem peminjaman ruangan')
        ...
        <div class="bg-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-300 mt-1">Total: {{ $staff->count() }} petugas terdaftar</p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($staff as $index => $petugas)
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <div class="flex items-center">
                                <div class="h-12 w-12 flex-shrink-0">
                                    <div class="h-12 w-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-semibold text-lg">
                                        {{ strtoupper(substr($petugas->nama_petugas ?? 'P', 0, 1)) }}
                                    </div>
                                </div>
                                <div class="ml-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex gap-2">
                                ...
                                <a href="{{ route('staff.edit', $petugas->id_petugas) }}" 
                                ...
                                @if(Route::has('staff.destroy'))
                                <form action="{{ route('staff.destroy', $petugas->id_petugas) }}" 
                                      method="POST" 
