...
@section('page-subtitle', 'Kelola semua ruangan yang tersedia untuk peminjaman')

@section('content')
<!-- Tombol Aksi -->
<div class="mb-6 flex justify-end">
    <a href="{{ route('rooms.create') }}" class="gradient-bg hover:shadow-xl text-white px-6 py-3 rounded-xl font-bold shadow-lg transition-all duration-300 transform hover:scale-105">
        ...
        <div class="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-orange-300 transform hover:scale-105">
            ...
            <div class="p-6 border-b border-orange-200 gradient-bg">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <h3 class="text-2xl font-bold text-white mb-1">{{ $room->nama_room }}</h3>
            ...
            <div class="p-6">
                ...
                <div class="mb-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-orange-900 font-bold text-xl">{{ $room->kapasitas }} Orang</p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-amber-800 text-base font-medium">{{ $room->deskripsi }}</p>
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <form action="{{ route('rooms.destroy', $room->id_room) }}" 
                          method="POST" 
                          class="flex-1"
                          onsubmit="return confirm('Yakin ingin menghapus ruangan {{ $room->nama_room }}?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
...
@else
    <div class="bg-white rounded-xl shadow-lg p-16 text-center">
        ...
        <a href="{{ route('rooms.create') }}" class="inline-block bg-gray-800 hover:bg-gray-900 text-white px-8 py-4 rounded-lg shadow-md transition-all duration-200">
